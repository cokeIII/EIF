...
CREATE TABLE `business` (
  ...
  `size` enum('ไม่ระบุ','SME','เล็ก','กลาง','ใหญ่') NOT NULL,
  `number_emp` int(11) NOT NULL,
  ...
  `date_vat` int(11) NOT NULL,
  `regis_capital` int(11) NOT NULL,
  `tax_deduction` enum('ใช้สิทธิ์','กำลังดำเนินการ','ไม่ใช้สิทธิ์','') NOT NULL,
...
INSERT INTO `business` (`id`, `branch_no`, `business_name`, `affiliation`, `size`, `number_emp`, `job_description`, `province_id`, `amphure_id`, `district_id`, `post_code`, `house_number`, `home_number`, `road`, `country`, `map`, `email`, `tel`, `date_vat`, `regis_capital`, `tax_deduction`, `create_time`, `update_time`, `password`, `group_id`) VALUES
('0105538066591', '00001', 'บริษัท อมตะซิตี้ ระยอง จำกัด ', '', 'ไม่ระบุ', 154, '', 11, 142, '200708', '20230', '', '7 หมู่  3 ', '', '', '', '', '', 1998, 0, 'ใช้สิทธิ์', '2020-07-27', '2020-07-27 10:16:24', '25d55ad283aa400af464c76d713c07ad', 2),
('0105553104423', '00001', 'บริษัท อมตะ บี.กริม เพาเวอร์ 5  จำกัด ', '', 'ไม่ระบุ', 245, '', 11, 136, '200109', '20000', '', '700/696 หม', '', 'ประเทศไทย', '', '', '', 0, 0, 'ใช้สิทธิ์', '2020-07-28', '2020-08-19 16:17:54', '25d55ad283aa400af464c76d713c07ad', 2),
('0205558025261', 'สำนักงานใหญ่', 'บริษัท อมตะไฟเบอร์กลาสเรซิน จำกัด ', '', 'ไม่ระบุ', 146, '', 11, 140, '710113', '20160', '', '399/664 หม', '', '', '', '', '', 2015, 0, 'ใช้สิทธิ์', '2020-08-02', '2020-08-02 16:20:10', '25d55ad283aa400af464c76d713c07ad', 9),
('Admin', '0', 'Admin', '', 'ไม่ระบุ', 0, '', 0, 0, '', '', '', '', '', '', '', '', '', 0, 0, '', '2020-07-27', '2020-07-28 08:11:38', 'c09439829437a31c87b766e495fc824e', 0);
...
--
-- Table structure for table `group_eec`
--

CREATE TABLE `group_eec` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `group_eec`
--

INSERT INTO `group_eec` (`id`, `name_th`, `name_en`) VALUES
...
(8, 'อุตสาหกรรมดิจิทัล', 'DIGITAL'),
(9, 'อุตสาหกรรมเชื้อเพลิงชีวภาพและเคมีชีวภาพ', 'BIOFUELS AND BIOCHEMICALS'),
...
CREATE TABLE `project` (
  ...
  `busi_id` varchar(13) NOT NULL,
  `branch_no` varchar(20) NOT NULL,
  `project_name` varchar(50) NOT NULL,
  `reason` varchar(500) NOT NULL,
  `objective` varchar(500) NOT NULL,
  `maingoal` varchar(500) NOT NULL,
  `persons` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  ...
  `budget` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `pro_status` enum('ผ่านการอนุมัติ','ไม่ผ่านการอนุมัติ','ขั้นเตรียมการ','ขั้นดำเนินกิจกรรม','ดำเนินงานแล้วเสร็จ','ยกเลิกโครงการ','รอการอนุมัติ') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `project` (`project_id`, `busi_id`, `branch_no`, `project_name`, `reason`, `objective`, `maingoal`, `persons`, `start_duration`, `end_duration`, `locations`, `product`, `indicator`, `project_date`, `budget`, `pro_status`) VALUES
(12, '0105553104423', '00001', 'บี.กริม เพาเวอร์ 5 2', ' หลักการและเหตุผล บี.กริม เพาเวอร์ 5 2', 'วัตถุประสงค์', 'เป้าหมายหลัก 2', '{\"1\":{\"perName\":\"บริษัท อมตะ บี.กริม เพาเวอร์ 5 จำกัด\",\"tel\":\"097 472 8763\",\"email\":\"coke2484@gmail.com\"},\"2\":{\"perName\":\"บริษัท อมตะ บี.กริม เพาเวอร์ 6 จำกัด\",\"tel\":\"097 472 8764\",\"email\":\"kasama@chontech.ac.th\"}}', '2020-06-29', '2020-09-18', ' สถานที่', 'ผลผลิต/ผลลัพธ์/ประโยชน์ที่คาดว่าจะได้รับ', 'วิธีการประเมินผลและดัชนีชี้วัดความสำเร็จของโครงการ', '2020-08-02 08:58:35', '{\"1\":{\"disBudget\":\"ค่ากิจกรรม\",\"num\":\"1\",\"unit\":\"กิจกรรม\",\"price\":\"8500\"},\"2\":{\"disBudget\":\"ค่าเดินทาง\",\"num\":\"2\",\"unit\":\"คน\",\"price\":\"2500\"},\"sumPrice\":\"15000\"}', 'ผ่านการอนุมัติ'),
(17, '0205558025261', 'สำนักงานใหญ่', 'ชื่อโครงการ ทดสอบ', 'หลักการและเหตุผล ทดสอบ', 'วัตถุประสงค์ ทดสอบ', 'เป้าหมายหลัก ทดสอบ', '{\"1\":{\"perName\":\"นาย A\",\"tel\":\"0875441236\",\"email\":\"kasama@chontech.ac.th\"},\"2\":{\"perName\":\"นาย B\",\"tel\":\"0974728763\",\"email\":\"coke2484@gmail.com\"}}', '2020-08-02', '2021-07-31', 'สถานที่ ทดสอบ', 'ประโยชน์ที่คาดว่าจะได้รับ ทดสอบ', 'ดัชนีชี้วัดความสำเร็จ ทดสอบ', '2020-08-02 16:37:40', '{\"1\":{\"disBudget\":\"ค่าอาหาร\",\"num\":\"10\",\"unit\":\"มื้อ\",\"price\":\"1500\"},\"2\":{\"disBudget\":\"ค่ากิจกรรม\",\"num\":\"7\",\"unit\":\"กิจกรรม\",\"price\":\"5000\"},\"sumPrice\":\"50000\"}', 'ผ่านการอนุมัติ');
...
--
-- Table structure for table `quarter_progress`
--

CREATE TABLE `quarter_progress` (
  `id` int(11) NOT NULL,
  `project_id` int(11) NOT NULL,
  `cost_budget` int(11) NOT NULL,
  `progress` int(3) NOT NULL,
  `quater` int(1) NOT NULL,
  `quater_year` year(4) NOT NULL,
  `qua_date` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `quarter_progress`
--

INSERT INTO `quarter_progress` (`id`, `project_id`, `cost_budget`, `progress`, `quater`, `quater_year`, `qua_date`) VALUES
(2, 12, 25000, 20, 3, 2020, '2020-08-02 15:05:39'),
(3, 17, 20000, 35, 3, 2020, '2020-08-02 16:42:52');
...
CREATE TABLE `quarter_project` (
  ...
  `status` enum('รายงานปัญหา','สรุปโครงการ','สรุปโครงการ_user') NOT NULL,
  `quater` int(1) NOT NULL,
  `qua_date` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
...
--
-- Dumping data for table `quarter_project`
--

INSERT INTO `quarter_project` (`qua_id`, `project_id`, `topic`, `detail`, `status`, `quater`, `qua_date`, `file_name`) VALUES
(145, 12, 'ตัวชี้วัดที่1', 'รายงาน1', 'สรุปโครงการ', 3, '2020-08-01 09:56:10', ''),
(152, 12, 'ตัวชี้วัดที่2', 'รายงาน2', 'สรุปโครงการ', 3, '2019-08-01 09:56:44', ''),
(155, 12, 'หัวข้อปัญหา 1', 'รายละเอียดของปัญหา1', 'รายงานปัญหา', 3, '2020-08-02 06:59:28', '20200802085928_quarter_project.sql'),
(159, 12, 'หัวข้อ', 'รายละเอียด\r\n', 'สรุปโครงการ_user', 3, '2020-08-02 14:40:06', ''),
(168, 12, 'หัวข้อ', 'รายละเอียด', 'สรุปโครงการ_user', 3, '2020-08-02 15:31:02', ''),
(169, 17, 'หัวข้อปัญหา ทดสอบ', 'รายละเอียดของปัญหา ทดสอบ', 'รายงานปัญหา', 3, '2020-08-02 16:40:16', '20200802184016_quarter_project.sql'),
(170, 17, 'หัวข้อสรุปรายงาน ทดสอบ', 'รายละเอียดรายงาน  ทดสอบ', 'สรุปโครงการ_user', 3, '2020-08-02 16:42:52', ''),
(171, 17, 'ตัวชี้วัดที่1 ทดสอบ', 'รายละเอียดตัวชี้วัดที่1 ทดสอบ', 'สรุปโครงการ', 3, '2020-08-02 17:02:47', ''),
(173, 17, 'ตัวชี้วัดที่2 ทดสอบ', 'รายละเอียดตัวชี้วัดที่2 ทดสอบ', 'สรุปโครงการ', 3, '2020-08-02 17:02:54', '');
...
INSERT INTO `schedule` (`sch_id`, `project_id`, `detail`, `date`) VALUES
(4, 12, 'tset', '0000-00-00'),
(5, 12, 'test2', '0000-00-00');
...
--
-- Indexes for table `group_eec`
--
ALTER TABLE `group_eec`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `quarter_progress`
--
ALTER TABLE `quarter_progress`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT for table `group_eec`
--
ALTER TABLE `group_eec`
...
--
-- AUTO_INCREMENT for table `quarter_progress`
--
ALTER TABLE `quarter_progress`
...
--
ALTER TABLE `quarter_project`
  MODIFY `qua_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=174;
...
--
ALTER TABLE `project`
  ADD CONSTRAINT `business` FOREIGN KEY (`busi_id`) REFERENCES `business` (`id`);

--
-- Constraints for table `quarter_progress`
--
ALTER TABLE `quarter_progress`
  ADD CONSTRAINT `quarter_progress_ibfk_1` FOREIGN KEY (`project_id`) REFERENCES `project` (`project_id`);
...
--
ALTER TABLE `schedule`
  ADD CONSTRAINT `schedule_ibfk_1` FOREIGN KEY (`project_id`) REFERENCES `project` (`project_id`);
COMMIT;
