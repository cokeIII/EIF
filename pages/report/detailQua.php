                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-5">';
                                ...
                                <div><b>งบประมาณที่ใช้ในไตรมาสนี้ : </b> '.$rowProgress["cost_budget"].'</div>
                                <div><b>ความคืบหน้า : </b> 
                                
                                <div class="progress progress-sm">
                                    <div class="progress-bar bg-green" role="progressbar" aria-volumenow="'.$rowProgress["progress"].'" aria-volumemin="0" aria-volumemax="100" style="width: '.$rowProgress["progress"].'%">
                                </div>
                                </div>
                                <small>'
                                .$rowProgress["progress"].'% Complete
                                </small>
