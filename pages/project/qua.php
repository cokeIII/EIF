...
'<div class="content-header">
    ...
    <div class="row mb-2">
        <div class="col-sm-6">
        <h1 class="m-0 text-dark">สรุปรายงาน</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
        ...
        <div class="row ">
            <div class="col-md-12">
                <div class="card" id="formProjects">
                    <div class="card-body">
                        <table class="table table-bordered hover projects" id="tableQua">
                            <thead>
                                <tr>
                                    <th style="width: 1%">
                                        ลำดับ
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                $jsonData.='<tr>
                                    ...
                                    <a class="btn btn-primary btn-sm  mt-3 btn-qua" href="#"  proName="'.$row["project_name"].'" proId="'.$row["project_id"].'">
